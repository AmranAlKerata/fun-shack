    ...
    function k() {
      ...
      return (
        (null === (e = w.calendarContainer) || void 0 === e
          ? void 0
          : e.getRootNode()).activeElement || document.activeElement
      );
    }
    function T(e) {
      return e.bind(w);
        ...
        "range" === w.config.mode &&
          (function(e) {
            return (
              ...
              (M(e, w.selectedDates[0]) >= 0 && M(e, w.selectedDates[1]) <= 0)
            );
          })(n) &&
          !be(n) &&
    ...
    function se() {
      "object" != typeof w.config.locale &&
        ...
        (w.l10n = e(
          ...
          "object" == typeof w.config.locale
            ? w.config.locale
            : "default" !== w.config.locale ? I.l10ns[w.config.locale] : void 0
        )),
          ...
          w.isMobile ||
            (function() {
              ...
              w.config.static ||
                ...
                (void 0 !== w.config.appendTo
                  ? w.config.appendTo
                  : window.document.body).appendChild(w.calendarContainer);
            })(),
          (function() {
            w.config.wrap &&
            ...
            if (w.isMobile)
              return void (function() {
                var e = w.config.enableTime
                  ? w.config.noCalendar ? "time" : "datetime-local"
                  : "date";
                (w.mobileInput = d(
                  "input",
